<!-- ARCHIVED 2026-08-17: this is the original un-customized template version of
     domain-reviewer.md (generic econometrics-flavored illustrative examples,
     AUTO-DETECT-TEMPLATE-MARKER intact), preserved for reference before this
     fork customized the active .claude/agents/domain-reviewer.md for
     bioenergy/circular-biorefinery research. Not loaded by any active agent. -->
---
